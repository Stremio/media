...
public class MediaCodecVideoRenderer extends MediaCodecRenderer
  ...
  public static final class Builder {
    ...
    /** Sets whether Dolby Vision profile 7 may be mapped to HEVC base-layer decoders. */
    @CanIgnoreReturnValue
  ...
  public static @Capabilities int supportsFormat(
    ...
    return supportsFormatInternal(
        context, mediaCodecSelector, format, /* mapDV7ToHevc= */ false);
  }

  @Override
  protected @Capabilities int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format)
      throws DecoderQueryException {
    return supportsFormatInternal(context, mediaCodecSelector, format, mapDV7ToHevc);
  }

  private static @Capabilities int supportsFormatInternal(
      Context context, MediaCodecSelector mediaCodecSelector, Format format, boolean mapDV7ToHevc)
      throws DecoderQueryException {
  ...
  protected List<MediaCodecInfo> getDecoderInfos(
    ...
    return MediaCodecUtil.getDecoderInfosSortedByFormatSupport(
        context,
        getDecoderInfos(
            context, mediaCodecSelector, format, requiresSecureDecoder, tunneling, mapDV7ToHevc),
        format);
  }
  ...
  private void maybeSetupTunnelingForFirstFrame() {
    ...
    tunnelingOnFrameRenderedListener = new OnFrameRenderedListener(codec);
    if (SDK_INT >= 33) {
  ...
  private final class OnFrameRenderedListener
